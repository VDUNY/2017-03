...
namespace Website
{
	[EventSource( Name = "MyCompany-Demo4-Website" )]
	internal sealed class ServiceEventSource : EventSource
	{
		...
		public static class Keywords
		{
			...
			public const EventKeywords Security = (EventKeywords)0x4L;
		}
		...
		private const int SuccessfulLoginEventId = 7;
		[Event( SuccessfulLoginEventId, Level = EventLevel.Informational, Message = "User {0} successfully logged in", Keywords = Keywords.Security )]
		public void SuccessfulLogin( string username )
		{
			WriteEvent( SuccessfulLoginEventId, username );
		}

		private const int SuccessfulLogoutEventId = 8;
		[Event( SuccessfulLogoutEventId, Level = EventLevel.Informational, Message = "User {0} successfully logged out", Keywords = Keywords.Security )]
		public void SuccessfulLogout( string username )
		{
			WriteEvent( SuccessfulLoginEventId, username );
		}
