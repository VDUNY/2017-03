...
namespace Stateful1
{
	...
	internal sealed class Stateful1 : StatefulService
	{
		...
		/// <summary>
		/// This is the main entry point for your service replica. This method executes when
		/// this replica of your service becomes primary and has write status.
		/// </summary>
		...
		protected override async Task RunAsync( CancellationToken cancellationToken )
		{
			...
			while ( true )
			{
				...
				using ( var tx = StateManager.CreateTransaction() )
				{
					...
					// If an exception is thrown before calling CommitAsync, the transaction
